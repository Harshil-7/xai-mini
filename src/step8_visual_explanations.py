...
class_scores = df.groupby("pred")["mask_mean"].mean().sort_values()
...
top_nodes = df.groupby("node")["mask_mean"].mean().sort_values(ascending=False).head(10)
